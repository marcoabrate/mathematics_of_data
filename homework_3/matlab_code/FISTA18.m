% FUNCTION: fout = FISTA_18(fx, gx, gradf, proxg, x0, Lips, maxit, tolx)
% PURPOSE:  FISTA (for problem 4 equation 18) algorithm.
%
function fout = FISTA18(fx, gx, gradf, proxg, x0, Lips, maxit, tolx, verbose)
