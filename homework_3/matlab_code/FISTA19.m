% FUNCTION: fout = FISTA_19(fx, gx, gradf, proxg, x0, Lips, maxit, tolx)
% PURPOSE:  FISTA (for problem 4 equation 19) algorithm.
%
function fout = FISTA19(fx, gx, gradf, proxg, x0, Lips, maxit, tolx, verbose)
