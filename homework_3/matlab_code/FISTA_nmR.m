% FUNCTION: fout = FISTA_nmR(fx, gx, gradf, proxg, x0, Lips, maxit, tolx)
% PURPOSE:  FISTA (for problem 4 equation 18) algorithm with non-monotonicity restart.
%
function [fout, F_star] = FISTA_nmR(fx, gx, gradf, proxg, x0, Lips, maxit, tolx, verbose)
